...
def install():
    ...
    print("3. Click 'Load unpacked' and select the 'contrib/chrome-extension/dist' directory")
    print(f"   (located at {Path(__file__).parent / 'contrib' / 'chrome-extension' / 'dist'})")
